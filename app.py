...
if ENV == 'dev':
    ...
    app.debug=False
    app.config['DATABASE_URL'] = 'postgres://udiwryvygnuuua:98d6f9fedd5af9774bdc04b2135cf8743d9f4feec535d8f637e1fc9aaf47dff7@ec2-34-232-191-133.compute-1.amazonaws.com:5432/db6tnocfgodu9r'
